...
def answer(request):
    ...
    if category_last_answered == 0:
        ...
        try:
            ...
            print('===============================++++++++++++++++=========================')
            print('There is more than one question with question number {} in the {} category fix it.'
                    .format(category_last_answered+1,category))
            print('===============================++++++++++++++++=========================')
            raise

        except ObjectDoesNotExist:
            messages.success(request,
                    "Congratulations all questions are done in this category.")
